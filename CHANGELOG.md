...
## [6.1.6](https://github.com/airbus-cyber/graylog-plugin-alert-wizard/compare/6.1.5...6.1.6)
### Features
* Rules page is paginated ([issue #165](https://github.com/airbus-cyber/graylog-plugin-alert-wizard/issues/165))
...
* Rules list page is reloaded twice ([issue #162](https://github.com/airbus-cyber/graylog-plugin-alert-wizard/issues/162))
* Rules filter is case-sensitive ([issue #163](https://github.com/airbus-cyber/graylog-plugin-alert-wizard/issues/163))
...
* Bump graylog-plugin-logging-alert version to 6.1.4 ([issue #56](https://github.com/airbus-cyber/graylog-plugin-logging-alert/issues/56))
...
### Bug Fixes
* Cannot rename a rule ([issue #128](https://github.com/airbus-cyber/graylog-plugin-alert-wizard/issues/128))

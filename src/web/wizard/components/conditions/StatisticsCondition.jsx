...
const StatisticsCondition = ({alert, onUpdate}) => {
    ...
    return (
        <>
            ...
            <br/>
            <StatisticalInput onUpdate={_handleChangeCondition} type={state.alert.condition_parameters.type}
                              field={state.alert.condition_parameters.field} threshold={state.alert.condition_parameters.threshold}
                              thresholdType={state.alert.condition_parameters.threshold_type}/>
            <br/>

...
public class AlertRuleResource extends RestResource implements PluginRestResource {
    ...
    private final Validator importValidator;
    ...
    public AlertRuleResource(AlertRuleService alertRuleService,
        ...
        this.importValidator = new Validator(new FieldRulesUtilities(), true);
    ...
    private GetDataAlertRule constructDataAlertRule(AlertRule alert) {
        ...
        if (event.isPresent()) {
            ...
            if (fieldSpec != null && fieldSpec.providers() != null && !fieldSpec.providers().isEmpty()) {
                ...
                if (fieldValueProvider.isPresent()) {
                    aggregationTime = ((AggregationFieldValueProvider.Config) fieldValueProvider.get()).aggregationTimeRange();
                }
            }
